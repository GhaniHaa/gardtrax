      ...
      <div class="row">
        <div class="col-md-4 border-right">
          <div class="mb-6 text-center">
            <img
              ...
              width="150px"
              src="https://gardtrax-admin.tdpindonesia.id/dist/img/user-avatar.png"
            />
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
            <span class="font-weight-bold">Customer :</span>
            <span class="text-muted">Customer Test 1</span>
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
            <span class="font-weight-bold">No. NPWP :</span>
            <span class="text-muted">124124312412412</span>
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
          ...
          <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <span class="text-muted">Operasional</span>
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
            <span class="font-weight-bold">Jabatan :</span>
            <span class="text-muted">Komandan Regu (Danru)</span>
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
          ...
          <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <span class="text-muted"> TDP Bandung</span>
          </div>
        </div>
        <div class="col-md-4 border-right">
          <div class="d-flex align-items-center justify-content-between mb-3">
            <span class="font-weight-bold">Tempat Lahir :</span>
            <span class="text-muted">bumi</span>
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
          ...
          <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <span class="text-muted">ferialfahri@gmail.com</span>
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
          ...
          <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <span class="text-muted"> Kawin</span>
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
          ...
          <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <span class="text-muted"> 04/13/2021 </span>
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
          ...
          <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <span class="text-muted"> 123456667</span>
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
        ...
        <div class="col-md-4 border-right">
          ...
          <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <span class="text-muted">01/01/1970</span>
          </div>
          <div class="d-flex align-items-center justify-content-between mb-3">
